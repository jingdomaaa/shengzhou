...
var Template = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Template() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Template.__proto__ || Object.getPrototypeOf(Template)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.config = {
  ...
  return Template;
}(_index.Component), _class.$$events = [], _class.$$componentPath = "pages/statistic/team", _temp2);
